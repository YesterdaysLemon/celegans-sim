 ...
 * but state is not nothing. A second animal costs a measured 240,304 bytes, 235 kB, of
...
class World {
   ...
   * the ordinary case and 1.5 MB in the worst, against 240,304 bytes for a whole animal:
